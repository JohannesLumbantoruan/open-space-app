...
describe('talksReducer function', () => {
    ...
    it('should return the talks with the new talk when given ADD_TALK action', () => {
        // arrange
        const initialState = [
            {
                id: 'talk-1',
    ...
    it('should return the talks with toggled like when given TOGGLE_LIKE_TALK action', () => {
        // arrange
        const initialState = [
            {
                id: 'talk-1',
